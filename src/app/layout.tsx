        ...
        <div className="relative z-10">
          <nav className="bg-black border-b border-[#333] py-4">
            <div className="container mx-auto px-4">
              <div className="flex justify-between items-center">
                <a
                  href="/"
                  className="text-xl font-bold hover:text-[#ff69b4] transition-colors font-['Press_Start_2P']"
                >
                  Compressionism
                </a>
                <div className="hidden md:flex items-center space-x-8">
                  <Link
                    href="/"
                    className="text-white/90 hover:text-[#00ff00] transition-colors font-['VT323'] text-xl"
                  >
                    HOME
                  </Link>
          ...
          <footer className="bg-black border-t border-[#333] py-8">
            <div className="container mx-auto px-4 text-center text-white/70 font-['VT323']">
              <p>
                &copy; {new Date().getFullYear()} Compressionism. All rights
                reserved.
              </p>
            </div>
          </footer>
